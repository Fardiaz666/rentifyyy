...
import { Package, Clock, CheckCircle, MapPin, Truck, ArrowLeft, ShoppingBag, Eye, X, Send, XCircle, ArrowUpRight, Copy } from 'lucide-react';
                ...
                >
                    ...
                    >
                        <form onSubmit={handleSubmit} className="p-6">
                            ...
                            <p className="text-sm text-slate-500 mb-6">Barang harus dikirim kembali ke alamat pemilik toko.</p>
...
const SellerOrdersPage = ({ onPageChange }) => { 
    ...
    const handleConfirmReceived = (id) => {
        if (window.confirm("Konfirmasi barang telah DITERIMA? Dana akan segera dicairkan.")) {
            setProcessingId(id);
            setTimeout(() => {
                                ...
                                <tr key={order.id} className="hover:bg-slate-50/50 transition">
                                    ...
                                    <td className="px-6 py-4 whitespace-nowrap">
                                        <div className="flex items-center gap-2">
                                            ...
                                            {/* KONDISI 3: Menunggu Penerimaan (Barang dikirim kembali oleh pembeli) */}

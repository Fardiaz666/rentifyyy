...
// PENTING: PASTIKAN NAMA FILE INI SESUAI DENGAN YANG ADA DI FOLDER src/assets/
...
export const INITIAL_PRODUCTS = [
  ...
  { 
    ...
    description: 'Kamera mirrorless full-frame profesional. Low light performance juara.', 
    pricePerDay: 350000, 
  ...
  { 
    ...
    category: 'Studio Kreator', 
    description: 'Lampu studio continuous light yang terang dan stabil. Wajib punya buat bikin konten YouTube.', 
    pricePerDay: 120000, 
  ...
  { 
    ...
    category: 'Studio Kreator', 
    description: 'Stabilizer kamera 3-axis yang ringan namun kuat. Bikin footage video kamu cinematic tanpa guncangan.', 
    pricePerDay: 150000, 
